  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="pl-80 pr-80">
        {/* Floating Settings Button - positioned in top center of content area */}
        <button
          onClick={handleResetApiKey}
          className="fixed top-4 left-1/2 -translate-x-1/2 bg-slate-700/90 hover:bg-slate-600/90 text-white px-4 py-2 rounded-lg shadow-lg z-50 transition-colors flex items-center gap-2"
